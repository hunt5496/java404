...
public class Main {
    public static void dbTest() {
        ...
        try{
            ...
            // DriverManager 를 사용하여 지정한 데이터베이스에 사용자 ID/PW를 사용하여 접속
...
//        member.setUser_email("testuser@bitc.ac.kr");
...
//        parser.selectDB();
        ...
        // json데이터를 제공하는 서비스 주소
        String url = "https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=f5eef3421c602c6cb7ea224104795888&targetDt=20240403";
        // 서비스를 사용하기 위한 키 설정
